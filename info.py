...
doc = {'name':'김재혁',
       ...
       'strength':"리더가 되면 뒤쳐지는 팀원이 없도록 꼼꼼히 살핀 후 잘 이끌어 나갑니다!",
...
doc = {'name':'배병일',
       'MBTI':"INFP",
       'image':"https://files.slack.com/files-tmb/T043597JK8V-F058N8MAQJC-f4a5a7d007/img_2195_720.jpg",
...
doc = {'name':'오준석',
       'MBTI':"INFP",
       'strength':"여러 의견을 귀 기울여 들을 줄 아는 세심한 프로소통러입니다!",
